...
(function() {
    describe("Test ChangesetStorageHandler", function() {
        ...
        it('test convert model to geoJson feature', function() {
            var model = {"id":"1","networkId":1,"quadKey":"120221323002221",
            ...
            var expcetedGeoJsonFeature = { geometry: Object({ coordinates: [ [ 9.155424933224905, 45.473155054278905 ],
                [ 9.155258933244912, 45.47059695431359 ] ], type: 'LineString' }), type: 'Feature',
                properties: Object({ modes: 'car,ride', zoomlevel: 13, length: 285.35880418880106,
        ...
        it('test convert full model to GeoJson', function() {
            var fullModel = {"id":9,"name":"ChangesetTest","networkId":1,"userNr":1,"lastModified":1463649230713,
                "link_changeModels":[{"defaultValues":{"id":"31078720","networkId":1,
            ...
            var expectedGeoJson = { features: [ Object({ geometry: Object({ coordinates: [ [ 8.601731336993339, 46.70546623573138 ],
                ...
                properties: Object({ modes: 'car,ride', zoomlevel: 10, length: 9110.444119989446,
                    ...
                    capacity: 4000 }) }) ], type: 'FeatureCollection' };
